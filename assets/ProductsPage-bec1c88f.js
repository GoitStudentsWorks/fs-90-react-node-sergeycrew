...
`;E.div`
  ...
  font-size: 14px;
`;const Fe="#1c1c1c",ce="#efede8",to="rgba(239, 237, 232, 0.1)",at={option:n=>({...n,background:Fe,color:ce,textwrap:"nowrap"}),control:n=>({...n,backgroundColor:"transparent",borderRadius:"12px",width:"100%",height:"46px",border:"1px solid rgba(239, 237, 232, 0.2)",boxShadow:"none","&:hover":{borderColor:"#E6533C"},"&:focus":{borderColor:"#E6533C"},"@media (min-width: 768px)":{height:"50px"}}),dropdownIndicator:n=>({...n,display:"none","@media (min-width: 768px)":{display:"flex",justifyContent:"flex-end",color:ce}}),menu:n=>({...n,background:Fe,borderRadius:"12px"}),menuList:n=>({...n,"::-webkit-scrollbar":{width:"22px"},"::-webkit-scrollbar-track":{background:"transparent"},"::-webkit-scrollbar-thumb":{background:to,borderRadius:"12px",border:"7px solid",borderColor:Fe},maxHeight:"276px",borderRadius:"12px",overflowX:"hidden"}),indicatorSeparator:n=>({...n,display:"none"}),placeholder:n=>({...n,color:ce}),singleValue:n=>({...n,color:ce}),container:n=>({...n,display:"flex",alignItems:"center",border:"1px",height:"46px",width:"100%","&:hover":{borderColor:"#E6533C"},"&:focus":{borderColor:"#E6533C"},"@media (min-width: 768px)":{height:"50px"}}),input:n=>({...n,fontSize:"14px"})},ut=[{value:"",label:"All"},{value:"recommended",label:"Recommended"},{value:"not recommended",label:"Not recommended"}],no=()=>{const n=ge(),e=Y(mt),i=Qt({initialValues:{title:"",category:"",type:""},validate:l=>{const o=l.title.trim();o&&o.length<2},onSubmit:l=>a(l)}),t=(l,o)=>{if(l){const s=l.find(c=>c.value==o);return s||""}else return""},a=l=>{n(Gt(l)),n(pt()),n(Me())},u=(l,o)=>{i.setFieldValue(l,o.value);const{initialValues:s,values:c}=i;if(o.value!==s[o.value]){const d={...c,[l]:o.value};a(d)}};return h.jsxs(Yi,{onSubmit:i.handleSubmit,children:[h.jsx(qi,{type:"text",name:"title",placeholder:"Search",value:i.values.title,onChange:i.handleChange}),i.values.title!==""&&h.jsx(Ki,{type:"button",onClick:()=>{i.setFieldValue("title",""),i.setFieldValue("category",""),i.setFieldValue("type","")},children:h.jsx(Ji,{children:h.jsx("use",{href:`${ie}#x2`})})}),h.jsx(Zi,{type:"submit",children:h.jsx(Qi,{children:h.jsx("use",{href:`${ie}#search`})})}),h.jsxs(eo,{children:[h.jsx(ot,{value:t(e,i.values.category),onChange:l=>u("category",l),options:e,placeholder:"Categories",styles:at}),h.jsx(ot,{value:t(ut,i.values.type),onChange:l=>u("type",l),options:ut,styles:at})]}),h.jsx(Xi,{children:"Filters"})]})},ro=n=>n.$recommended?n.theme.colors.recommendedColor:n.theme.colors.notRecommendedColor,io=E.div`
  height: 141px;
...
`,mo=({product:{_id:n,title:e,calories:r,category:i,weight:t,recommended:a=!0},toggleModal:u})=>h.jsxs(io,{children:[h.jsxs(oo,{children:[h.jsx(ao,{children:"diet"}),h.jsx(uo,{$recommended:a}),h.jsx(st,{children:h.jsx("b",{children:a?"Recommended":"Not recommended"})}),h.jsxs(so,{onClick:()=>u({_id:n,title:e,calories:r,category:i,weight:t}),children:["Add",h.jsx(lo,{children:h.jsx("use",{href:`${ie}#icon-arrow`})})]})]}),h.jsxs(co,{children:[h.jsx(fo,{children:h.jsx("use",{href:`${ie}#icon-icon`})}),h.jsx(po,{children:e})]}),h.jsxs(ho,{children:[h.jsxs(we,{children:[h.jsx(Oe,{children:"Calories:"})," ",h.jsx(lt,{children:r})]}),h.jsxs(we,{children:[h.jsx(Oe,{children:"Category: "})," ",h.jsx(st,{children:i})]}),h.jsxs(we,{children:[h.jsx(Oe,{children:"Weight:"})," ",h.jsx(lt,{children:t})]})]})]}),go=E.ul`
  display: flex;
  justify-content: center;
  flex-wrap: wrap;
  color: #efede8;
...
`,Mo=({onToggle:n,exerciseInfo:e,setIsSuccessOpen:r,setDairyProduct:i})=>{const t=ge(),{weight:a,calories:u,_id:l,title:o}=e,[s,c]=p.useState(a),d=Math.round(s*u/100),v=Y(mt).filter(m=>m.value===e.category)[0].img;t(Yt(v));const b=()=>{if(!d)return;const m={productId:l,amount:s,calories:d};t(Xt(m)),i({calories:m.calories}),r(),n()};return h.jsx(bo,{modalStyles:{width:"335px"},modalTabletStyles:{width:"479px"},modalDesktopStyles:{width:"479px"},onClose:n,children:h.jsxs(xo,{children:[h.jsxs(Eo,{children:[h.jsx(Co,{type:"text",value:o,readOnly:!0,disabled:!0}),h.jsxs(So,{children:[h.jsx(yo,{type:"number",value:s,onChange:m=>{c(m.target.value)}}),h.jsx(Fo,{children:"grams"})]})]}),h.jsxs(Io,{children:[h.jsx(wo,{children:"Calories:"}),h.jsx(Oo,{children:d})]}),h.jsxs(Do,{children:[h.jsx(Po,{onClick:b,children:"Add to diary"}),h.jsx(Ao,{onClick:n,children:"Cancel"})]})]})})},Vo=E(ft)``,Lo=E.button`
  border-radius: 12px;
  background: #e6533c;
  padding: 14px 32px;
  justify-content: center;
...
`,_o=({calories:n,onClose:e})=>{const r=Y(cn);return h.jsx(Vo,{modalStyles:{maxWidth:"335px",width:"100%",height:"384px"},modalTabletStyles:{width:"430px",height:"439px"},modalDesktopStyles:{width:"430px",height:"439px"},onClose:e,children:h.jsxs(ko,{children:[h.jsx(Ro,{src:r,alt:"Category Image"}),h.jsxs($o,{children:[h.jsx(To,{children:"Well done"}),h.jsx("ul",{children:h.jsxs(Bo,{children:["Calories:",h.jsx(jo,{children:n||0})]})})]}),h.jsx(Lo,{onClick:e,children:"Next product "}),h.jsxs(Ho,{to:"/diary",children:["To the diary",h.jsx("svg",{width:" 16px",height:"16px",children:h.jsx("use",{href:`${ie}#arrow_gray`})})]})]})})},zo=()=>{const n=ge(),e=Y(Ve),r=Y(ht),[i,t]=p.useState(!1),[a,u]=p.useState(!1),[l,o]=p.useState(null),[s,c]=p.useState({calories:0}),d=Y(dn),g=Y(pn),v=()=>{n(Kt(1)),n(Me())},b=m=>{t(f=>!f),o(m)};return h.jsxs("div",{children:[h.jsxs(go,{children:[e.map(m=>h.jsx(vo,{children:h.jsx(mo,{product:m,toggleModal:b})},m._id)),!r&&d!==g&&h.jsx(on,{type:"button",onClick:()=>v(),children:"Load More"})]}),i&&h.jsx(Mo,{onToggle:b,setIsSuccessOpen:()=>u(m=>!m),exerciseInfo:l,setDairyProduct:c}),a&&h.jsx(_o,{onClose:()=>u(m=>!m),calories:s.calories})]})},Uo=E.div`
  display: flex;
  flex-direction: column;
  gap: 16px;
...
`,dt=E.span`
  color: ${n=>n.theme.colors.orangeColor};
`,No=()=>h.jsxs(Uo,{children:[h.jsxs(ct,{children:[h.jsx(dt,{children:"Sorry, no results were found "}),"for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),h.jsx(ct,{children:h.jsx(dt,{children:"Try changing the search parameters."})})]}),Wo=E.div`
...
`,qo=({children:n})=>h.jsx(Xo,{children:n}),ea=()=>{const n=ge(),e=Y(Ve),r=Y(ht);return p.useEffect(()=>{n(Jt()),n(pt()),n(Me())},[n]),h.jsx(qo,{children:h.jsx(Wo,{children:h.jsxs(Zt,{children:[h.jsxs(Go,{children:[h.jsx(Yo,{children:"Products"}),h.jsx(no,{})]}),r&&h.jsx(an,{positionPc:{transform:"translateX(-16%)"}}),e.length===0&&!r&&h.jsx(No,{}),e.length>0&&h.jsx(zo,{})]})})})};export{ea as default};
